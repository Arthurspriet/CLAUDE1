...
@click.command()
@click.option("-m", "--model", default=DEFAULT_MODEL, help="Ollama model to use")
...
def main(model: str, auto_accept: bool, working_dir: str | None, print_mode: bool,
         verbose: bool, resume: bool, temperature: float | None, prompt: str | None):
    """Claude1 - A local coding assistant powered by Ollama."""
