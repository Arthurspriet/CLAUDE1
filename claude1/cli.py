#!/usr/bin/env python3
"""Claude1 - Local Coding Assistant. CLI entry point."""
...
from claude1.config import AppConfig, DEFAULT_MODEL, HF_TOKEN, HF_ENDPOINT, parse_model_spec
from claude1.logging_config import setup_logging
from claude1.model_profiles import get_profile
...
def main(model: str, auto_accept: bool, working_dir: str | None, print_mode: bool,
    ...
    if print_mode:
        ...
        if resume:
            from claude1.session import get_latest_session
...
def cli():
    """Entry point for the `claude1` console script."""
    main()
